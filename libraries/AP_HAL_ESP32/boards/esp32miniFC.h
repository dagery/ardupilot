...
#define HAL_ESP32_SPI_DEVICES \
    {.name="MPU9250", .bus=0, .device=1, .cs=GPIO_NUM_2, .mode=0, .lspeed=1*MHZ, .hspeed=12*MHZ}
...
// MAG/COMPASS choices:
// or others:
#define AP_COMPASS_ENABLED 			TRUE
...
//							PROBE_MAG_I2C	(QMC5883L, 1, 0x0d,true ,  ROTATION_NONE)
...
// no airspeed sensor
#define AP_AIRSPEED_MS4525_ENABLED 				FALSE
#define AP_AIRSPEED_ENABLED 					FALSE
#define AP_AIRSPEED_ANALOG_ENABLED 				FALSE
#define AP_AIRSPEED_BACKEND_DEFAULT_ENABLED 	FALSE
...
// Enable inernal OSD
#define HAL_OSD_TYPE_DEFAULT 6
#define HAL_WITH_INT_OSD 0
#define ENABLE_OSD 0
...
//#define HAL_ESP32_RCOUT { GPIO_NUM_27, GPIO_NUM_26, GPIO_NUM_25, GPIO_NUM_33 }		//Used when JTAG debuging
...
#define HAL_SPRAYER_ENABLED 	FALSE //Disable sprayer functionality
//#define HAL_MOUNT_ENABLED  		FALSE
#define HAL_LOGGING_ENABLED 	FALSE
//#define AP_CAMERA_ENABLED		FALSE
#define HAL_SPRAYER_ENABLED 	FALSE
#define AP_RANGEFINDER_ENABLED 	FALSE
#define HAL_PROXIMITY_ENABLED	FALSE
//#define AP_OPTICALFLOW_ENABLED	FALSE
//#define AP_RPM_ENABLED			FALSE
